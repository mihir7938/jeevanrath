...
@section('content')
    <div class="container-fluid about bg-light py-5 mt-5">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-8 wow fadeInTop" data-wow-delay="0.2s">
                    <div class="search-form rounded p-5 mt-4">
                        <h4 class="display-7 mb-4 text-center">Search Fixed Route Cars</h4>
                        <form method="POST" action="{{route('search_fixed')}}" class="search_form" id="search_form">
        ...
        <div id="search_result">
            @include("search.fixed", ['vehicle_details' => $vehicle_details])
        </div>
    </div>
@endsection
@section('footer')
<script>
    $(function () {
        ...
        $('#search_form').submit(function(e){
            e.preventDefault();
            $("#search_result").html('');
            popoluteResults("{{ route('get_fixed_results') }}");
        });
    });
