                        ...
                        @elseif(Auth::check() && Auth::user()->isAdmin())
                            ...
                            <li class="nav-item">
                                <a href="{{route('admin.duty')}}" class="nav-link {{(Route::currentRouteName() == 'admin.duty') || (Route::currentRouteName() == 'admin.duty.edit') ? 'active' : '' }}">
                                    ...
                                    <p>Driver Duty (Same Day)</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="{{route('admin.entries')}}" class="nav-link {{(Route::currentRouteName() == 'admin.entries') || (Route::currentRouteName() == 'admin.entries.add') || (Route::currentRouteName() == 'admin.entries.edit') || (Route::currentRouteName() == 'admin.entries.list') || (Route::currentRouteName() == 'admin.entries.add.day') || (Route::currentRouteName() == 'admin.entries.list') || (Route::currentRouteName() == 'admin.entries.edit.day') ? 'active' : '' }}">
                                    <i class="nav-icon fa fa-calendar"></i>
                                    <p>Daily Entries (M/P)</p>
                                </a>
                            </li>
                            <li class="nav-item">
                            ...
                            <li class="nav-item {{(Route::currentRouteName() == 'admin.package.categories') || (Route::currentRouteName() == 'admin.package.categories.add') || (Route::currentRouteName() == 'admin.package.categories.edit') || (Route::currentRouteName() == 'admin.packages') || (Route::currentRouteName() == 'admin.packages.add') || (Route::currentRouteName() == 'admin.packages.edit') || (Route::currentRouteName() == 'admin.accounts') || (Route::currentRouteName() == 'admin.accounts.add') || (Route::currentRouteName() == 'admin.accounts.edit') || (Route::currentRouteName() == 'admin.packages.assign') || (Route::currentRouteName() == 'admin.charges') || (Route::currentRouteName() == 'admin.charges.add') || (Route::currentRouteName() == 'admin.charges.edit') || (Route::currentRouteName() == 'admin.cities') || (Route::currentRouteName() == 'admin.cities.add') || (Route::currentRouteName() == 'admin.cities.edit') || (Route::currentRouteName() == 'admin.types') || (Route::currentRouteName() == 'admin.types.add') || (Route::currentRouteName() == 'admin.types.edit') || (Route::currentRouteName() == 'admin.vehicles') || (Route::currentRouteName() == 'admin.vehicles.add') || (Route::currentRouteName() == 'admin.vehicles.edit') || (Route::currentRouteName() == 'admin.categories') || (Route::currentRouteName() == 'admin.categories.add') || (Route::currentRouteName() == 'admin.categories.edit') || (Route::currentRouteName() == 'admin.vendors') || (Route::currentRouteName() == 'admin.vendors.add') || (Route::currentRouteName() == 'admin.vendors.edit') || (Route::currentRouteName() == 'admin.drivers') || (Route::currentRouteName() == 'admin.drivers.add') || (Route::currentRouteName() == 'admin.drivers.edit') || (Route::currentRouteName() == 'admin.companies') || (Route::currentRouteName() == 'admin.companies.add') || (Route::currentRouteName() == 'admin.companies.edit') || (Route::currentRouteName() == 'admin.jrvehicles') || (Route::currentRouteName() == 'admin.jrvehicles.add') || (Route::currentRouteName() == 'admin.jrvehicles.edit') || (Route::currentRouteName() == 'admin.users') || (Route::currentRouteName() == 'admin.users.add') || (Route::currentRouteName() == 'admin.users.edit') || (Route::currentRouteName() == 'admin.users.change') ? 'menu-open' : '' }}">
                                <a href="#" class="nav-link {{(Route::currentRouteName() == 'admin.package.categories') || (Route::currentRouteName() == 'admin.package.categories.add') || (Route::currentRouteName() == 'admin.package.categories.edit') || (Route::currentRouteName() == 'admin.packages') || (Route::currentRouteName() == 'admin.packages.add') || (Route::currentRouteName() == 'admin.packages.edit') || (Route::currentRouteName() == 'admin.accounts') || (Route::currentRouteName() == 'admin.accounts.add') || (Route::currentRouteName() == 'admin.accounts.edit') || (Route::currentRouteName() == 'admin.packages.assign') || (Route::currentRouteName() == 'admin.charges') || (Route::currentRouteName() == 'admin.charges.add') || (Route::currentRouteName() == 'admin.charges.edit') || (Route::currentRouteName() == 'admin.cities') || (Route::currentRouteName() == 'admin.cities.add') || (Route::currentRouteName() == 'admin.cities.edit') || (Route::currentRouteName() == 'admin.types') || (Route::currentRouteName() == 'admin.types.add') || (Route::currentRouteName() == 'admin.types.edit') || (Route::currentRouteName() == 'admin.vehicles') || (Route::currentRouteName() == 'admin.vehicles.add') || (Route::currentRouteName() == 'admin.vehicles.edit') || (Route::currentRouteName() == 'admin.categories') || (Route::currentRouteName() == 'admin.categories.add') || (Route::currentRouteName() == 'admin.categories.edit') || (Route::currentRouteName() == 'admin.drivers') || (Route::currentRouteName() == 'admin.drivers.add') || (Route::currentRouteName() == 'admin.drivers.edit') || (Route::currentRouteName() == 'admin.companies') || (Route::currentRouteName() == 'admin.companies.add') || (Route::currentRouteName() == 'admin.companies.edit') || (Route::currentRouteName() == 'admin.jrvehicles') || (Route::currentRouteName() == 'admin.jrvehicles.add') || (Route::currentRouteName() == 'admin.jrvehicles.edit') || (Route::currentRouteName() == 'admin.users') || (Route::currentRouteName() == 'admin.users.add') || (Route::currentRouteName() == 'admin.users.edit') || (Route::currentRouteName() == 'admin.users.change') ? 'active' : '' }}">
                                    <i class="nav-icon fas fa-layer-group"></i>
                                    <p>Masters<i class="right fas fa-angle-left"></i></p>
                                </a>
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="{{route('admin.package.categories')}}" class="nav-link {{(Route::currentRouteName() == 'admin.package.categories') || (Route::currentRouteName() == 'admin.package.categories.add') || (Route::currentRouteName() == 'admin.package.categories.edit') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Package Categories</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('admin.packages')}}" class="nav-link {{(Route::currentRouteName() == 'admin.packages') || (Route::currentRouteName() == 'admin.packages.add') || (Route::currentRouteName() == 'admin.packages.edit') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Packages</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('admin.packages.assign')}}" class="nav-link {{(Route::currentRouteName() == 'admin.packages.assign') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Assign Packages</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('admin.charges')}}" class="nav-link {{(Route::currentRouteName() == 'admin.charges') || (Route::currentRouteName() == 'admin.charges.add') || (Route::currentRouteName() == 'admin.charges.edit') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Charges</p>
                                        </a>
                                    </li>
                                    <li class="nav-item">
                                        <a href="{{route('admin.accounts')}}" class="nav-link {{(Route::currentRouteName() == 'admin.accounts') || (Route::currentRouteName() == 'admin.accounts.add') || (Route::currentRouteName() == 'admin.accounts.edit') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Companies</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('admin.vendors')}}" class="nav-link {{(Route::currentRouteName() == 'admin.vendors') || (Route::currentRouteName() == 'admin.vendors.add') || (Route::currentRouteName() == 'admin.vendors.edit') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>Vendors</p>
                                        </a>
                                    </li>
                                    ...
                                    <li class="nav-item">
                                        <a href="{{route('admin.jrvehicles')}}" class="nav-link {{(Route::currentRouteName() == 'admin.jrvehicles') || (Route::currentRouteName() == 'admin.jrvehicles.add') || (Route::currentRouteName() == 'admin.jrvehicles.edit') ? 'active' : '' }}">
                                            <i class="far fa-circle nav-icon"></i>
                                            <p>JR Vehicles</p>
                                        </a>
                                    </li>
